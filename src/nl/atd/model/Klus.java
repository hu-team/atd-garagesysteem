...
public class Klus {
	...
	public String getFactuurOmschrijving() {
		return "Klus voor auto '" + this.auto.getMerk() + " " + this.auto.getModel() + "' met kenteken " + this.auto.getKenteken()
				+ "\n" + this.type + ": " + this.omschrijving;
	}
	...
	public double getTotaalPrijs() {
		...
		for(int i = 0; i < this.onderdelen.size(); i++) {
			totaal += this.onderdelen.get(i).getAantal() * this.onderdelen.get(i).getArtikel().getPrijs();
		}
