				...
				<form class="form-horizontal" method="post" action="addartikel">
					<fieldset>
						<div class="control-group">
							...
							<div class="controls">
								<input type="text" class="input-xlarge datepicker" id="van" name="van" value='<c:out value="${artikel.naam }" />'>
							</div>
						</div>
						<div class="control-group">
							<label class="control-label" for="tot">Tot: </label>
							<div class="controls">
								<input type="text" class="input-xlarge datepicker" id="tot" name="tot" value='<c:out value="${artikel.code }" />'>
							</div>
						</div>
						<div class="control-group">
