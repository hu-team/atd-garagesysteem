...
<head>
    ...
    <link id="base-style" href="css/atd.css" rel="stylesheet">
    ...
    <div class="navbar">
        <div class="navbar-inner">
            <div class="container-fluid">
                ...
                <a class="brand" href="index.html"><span>ATD</span></a>
                <!-- start: Header Menu -->
                            ...
                            <form class="form-horizontal">
                                <fieldset>
                                    ...
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                            <input type="text" class="span6 datepicker">
                                        </div>
                                    </div>
                                    <div class="control-group">
                                        <label class="control-label">Omschrijving: </label>
                                        <div class="controls">
                                            <textarea name="" id="" class="cleditor">
                                            </textarea>
                                        </div>
                                    </div>
                                </fieldset>
...
<!--                                         <input type="text" data-name="metaal" value="0"/>
    ...
    <footer>
        <p>
            <span style="text-align:left;float:left">&copy; 2015 <a href="http://themifycloud.com/downloads/janux-free-responsive-admin-dashboard-template/" alt="Bootstrap_Metro_Dashboard">ATD</a></span>
        </p>
    </footer>
    <!-- start: JavaScript-->
